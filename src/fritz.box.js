...
colorizePowerLevel(dsDocsis31Table, LEVEL["Empfangsrichtung"]);
colorizePowerLevel(dsDocsis30Table, LEVEL["Empfangsrichtung"]);
...
colorizePowerLevel(usDocsis31Table, LEVEL["Senderichtung"]);
colorizePowerLevel(usDocsis30Table, LEVEL["Senderichtung"]);
